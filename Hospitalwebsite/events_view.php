...
if($_GET['delete']){
                ...
                $sql = "DELETE FROM event WHERE id=$_GET[delete]";
...
<div class="col-md-11">
 ...
 <h1 style=" margin-top: -45px; margin-bottom: 45px; text-align:center; color:black; font-family:georgia,garamond;">Events From ARS Hospital</h1>
   <table class="table" style="margin-top: 8%;">
            <thead>
                    <th style="font-family:georgia,garamond;" width="10%">S.No</th>
                    <th style="font-family:georgia,garamond;" width="40%">Eents Title</th>
     ...
     <style type="text/css">
        ...
        <?php
                ...
                if ($result->num_rows > 0) 
                {
                            ...
                            <td style=color:black;>" . $row["event_title"]. "</td>
                            <td style=color:black;>" . $row["date_of_uploading"] . "</td>
                            <td style=color:black;>" . $row["date_of_closing"] ."</td>
                            <td><button type='button' class='btn btn-danger deleteb' onclick='myFunction()'><a href='?delete=$id' class='ask'>Delete event</a></button></td></tr>";
                            }
                            echo "</table>";
                } 
