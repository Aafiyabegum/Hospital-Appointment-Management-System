...
<div class="col-md-11">
    ...
    <h1 style=" margin-top: -45px; margin-bottom: 45px; text-align:center; color:black; font-family:georgia,garamond;">Appointment made patient details</h1>
    <table class="table" style="margin-top: 8%;">
     <thead>
                 <th style="font-family:georgia,garamond;" width="15%">Name</th>
                 <th style="font-family:georgia,garamond;" width="15%">Appointment_Date</th>
                 <th style="font-family:georgia,garamond;" width="10%">Email</th>
                 <th style="font-family:georgia,garamond;" width="15%">Contact No</th>
                 <th style="font-family:georgia,garamond;" width="15%">Description</th>
                 <th style="font-family:georgia,garamond;" width="10%">Specialist</th>
                 <th style="font-family:georgia,garamond;" width="10%">App No</th>
                 <th style="font-family:georgia,garamond;" width="10%">Options</th>
     </thead>
