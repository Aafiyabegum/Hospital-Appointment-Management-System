...
<div class="col-md-11">
   ...
   <h1 style=" margin-top: -25px; margin-bottom: 45px; text-align:center; color:black; font-family:georgia,garamond;">Offers Creation</h1>
 ...
 <?php
                        ...
                        if(isset($_POST['submit']))
                        {
                            ...
                            if($message!="")
                            {
                                ...
                                $insert_data = "INSERT INTO offer values (NULL, '$message', '1')";
                                            
                                $data_check = mysqli_query($con, $insert_data);

                                echo "<h4 style=color:red;>Offer Message Created Successfully...</h4>";
                                 echo "</br>";
                                            echo"
    ...
    <div style="padding: 50px;">
                ...
                <h3 style="font-family:Trebuchet MS;  color: #0c0c0c;">Offer Message</h3>
                <textarea name="message" id="" cols="50" rows="7" style="display: block; border: 2px solid blue; border-radius: 10px;color: black;" placeholder="Type the Offer Details"></textarea><br>
                                  
                 <div class="btn" style="padding: 15px;">
                 
                 <button type="submit" name="submit" class="btn btn-primary deleteb">Create Offer</button></div>
                </form>
    </div>
     </div>
