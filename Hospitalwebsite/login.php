        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="login.php" method="POST" autocomplete="">
                    <h2 class="text-center" style="color: #1560bd;">Login to ARS Hospital</h2>
...
<?php
                    ...
                    <input class="form-control" type="hidden" name="utype" value="user"></div>
                    <div class="form-group">
                    <input class="form-control button" type="submit" name="login" value="Login"></div>
                    
                    <div class="link login-link text-center">Not yet a member? <a href="signup-user.php">Signup now</a></div>
                    <div class="link login-link text-center">Go back to Home <a href="index.php">Go to Home</a></div>
</form>
</div>
</div>
</div>
