        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="signup-user.php" method="POST" autocomplete="">
                    <h2 class="text-center" style="color: #1560bd;">Signup with ARS Hospital</h2>
                    <p class="text-center">It is quick and easy to fill</p>
<?php
                    if(count($errors) == 1){
                        ?>
...
<?php
                    ...
                    <input class="form-control" type="text" name="name" placeholder="Your Name" required value="<?php echo $name ?>"></div>
                    <div class="form-group">
                    <input class="form-control" type="email" name="email" placeholder="Email Address" required value="<?php echo $email ?>"></div>
                    
                    <div class="form-group">
                    <input class="form-control" type="number" name="mobile" placeholder="94777123456" required></div>
                    ...
                    <div class="form-group">
                    <input class="form-control button" type="submit" name="signup" value="Signup"></div>
